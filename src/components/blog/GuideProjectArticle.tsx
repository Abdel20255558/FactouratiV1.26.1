        ...
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="mt-8 grid items-center gap-10 lg:grid-cols-[1.02fr_0.98fr]">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/10 p-4 shadow-2xl backdrop-blur">
              <img src="/blog-assets/5.PNG" alt="gestion de projet avec Factourati" loading="eager" fetchPriority="high" decoding="async" className="h-full w-full rounded-[1.5rem] object-cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <article className="max-w-4xl">
            ...
            <div className="mt-10 space-y-10">
              ...
              <figure className="overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm">
                <img src="/blog-assets/6.PNG" alt="Cree un projet dans Factourati" loading="lazy" decoding="async" className="w-full object-cover" />
              </figure>
              ...
              <figure className="overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm">
                <img src="/blog-assets/7.PNG" alt="Cree une tache dans Factourati" loading="lazy" decoding="async" className="w-full object-cover" />
              </figure>
              ...
              <figure className="overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm">
                <img src="/blog-assets/8.PNG" alt="Gestion des Taches et suivi avancement" loading="lazy" decoding="async" className="w-full object-cover" />
              </figure>
