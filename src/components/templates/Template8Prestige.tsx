        ...
        <div className="h-full rounded-t-2xl px-8 py-2" style={{ background: INK, color: '#fff' }}>
          <div className="flex h-full items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              {company?.logo ? (
                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-white/10 p-2" style={getInvoiceLogoBoxStyle(customization)}>
              ...
              <div className="mt-3 space-y-2 text-sm text-white/85">
                {vatRates.map((rate) => (
                  <div key={rate} className="flex items-center justify-between">
                    <span>TVA {rate}%</span>
                    <span className="font-semibold text-white">{formatAmount(vatGroups[rate])} MAD</span>
                  </div>
                ))}
              </div>
              <div
