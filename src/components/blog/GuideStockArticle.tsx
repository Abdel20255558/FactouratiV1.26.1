          ...
          <article className="max-w-4xl">
            ...
            <div className="mt-10 space-y-10">
              ...
              <figure className="overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm">
                <img src="/blog-assets/stock-alerts.svg" alt="alerte stock faible dans logiciel de gestion" loading="lazy" decoding="async" className="w-full object-cover" />
              </figure>
              ...
              <figure className="overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm">
                <img src="/blog-assets/stock-remaining.svg" alt="suivi du stock restant et des commandes produits" loading="lazy" decoding="async" className="w-full object-cover" />
              </figure>
              ...
              <figure className="overflow-hidden rounded-[1.75rem] border border-gray-200 bg-white shadow-sm">
                <img src="/blog-assets/stock-search.svg" alt="logiciel de gestion de stock pour PME au Maroc" loading="lazy" decoding="async" className="w-full object-cover" />
              </figure>
